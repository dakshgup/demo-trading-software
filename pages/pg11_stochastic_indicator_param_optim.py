...
dash.register_page(__name__,
                   path='/param-optim',
                   name='Stochastic Indicator Parameter Optimization(SLOW)',
)
colors = {
    'background': '#1E1E1E',
    'text': '#FFFFFF',
...
layout = html.Div(
    ...
    children=[
        html.H1(
            children='Stochastic Divergence Parameter Optimization',
            style={
                'textAlign': 'center',
                'color': colors['text'],
                'paddingTop': '20px'
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(id='output-params-optim', style={'color': colors['text'], 'paddingTop': '10px'})
                    ],
...
@callback(
    Output('output-params-optim','children'),
