                            ...
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        dcc.Dropdown(id='stock-input', options=dropdown_options),

                                        html.Label('Start Date', style={'color': colors['text'], 'padding': '20px'}),
                                        dcc.Input(id='start-date-input', type='text', value='1800-01-01'),
...
def update_plots(n_clicks, stock, start_date, end_date):
    if n_clicks is None or (not (n_clicks > 0)):
